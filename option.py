...
class Options():
    ...
    def __init__(self):
        ...
        # train_setは各行に「対照学習モデルを通して出力された特徴ファイルの2つ上のディレクトリ名\\1つ上のディレクトリ名」 -tab- 「ラベル名」
        # が書かれていると思われる
        ...
        parser.add_argument('--train', action='store_true', default=False, help='train only')  #指定されていたらTrue
        parser.add_argument('--test', action='store_true', default=False, help='test only')    #指定されていたらTrue
        ...
        parser.add_argument('--graphcam', action='store_true', default=False, help='GraphCAM') #指定されていたらTrue
